...
> **En machine :** Ces états correspondent **à la présence du courant ou non**.
...
> **Priorités opératoires :** Les équations booléennes se lisent de gauche à droite et dépendent des priorités opératoires PEMDAS comme en mathématiques.
...
> **Correspondance :** True = 1 (Vrai) et False = 0 (Faux) - Python gère automatiquement la conversion entre les valeurs booléennes et numériques.
